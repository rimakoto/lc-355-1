...
import { Shuffle, Heart, Palette, BookMarked } from 'lucide-react';
        ...
        <div className="w-full max-w-xl mt-8">
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-white shadow-md hover:shadow-lg text-stone-700 transition-all duration-200 hover:-translate-y-0.5"
            >
              <Shuffle size={20} />
              <span>换一句</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full shadow-md hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 ${
                isLiked
